...
func (c *FakeKubeClusters) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.KubeCluster, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(kubeclustersResource, c.ns, name), &v1alpha1.KubeCluster{})
...
func (c *FakeKubeClusters) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.KubeClusterList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(kubeclustersResource, kubeclustersKind, c.ns, opts), &v1alpha1.KubeClusterList{})
...
func (c *FakeKubeClusters) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(kubeclustersResource, c.ns, opts))
...
func (c *FakeKubeClusters) Create(ctx context.Context, kubeCluster *v1alpha1.KubeCluster, opts v1.CreateOptions) (result *v1alpha1.KubeCluster, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(kubeclustersResource, c.ns, kubeCluster), &v1alpha1.KubeCluster{})
...
func (c *FakeKubeClusters) Update(ctx context.Context, kubeCluster *v1alpha1.KubeCluster, opts v1.UpdateOptions) (result *v1alpha1.KubeCluster, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(kubeclustersResource, c.ns, kubeCluster), &v1alpha1.KubeCluster{})
...
func (c *FakeKubeClusters) UpdateStatus(ctx context.Context, kubeCluster *v1alpha1.KubeCluster, opts v1.UpdateOptions) (*v1alpha1.KubeCluster, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(kubeclustersResource, "status", c.ns, kubeCluster), &v1alpha1.KubeCluster{})
...
func (c *FakeKubeClusters) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(kubeclustersResource, c.ns, name, opts), &v1alpha1.KubeCluster{})
...
func (c *FakeKubeClusters) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(kubeclustersResource, c.ns, listOpts)
...
func (c *FakeKubeClusters) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.KubeCluster, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(kubeclustersResource, c.ns, name, pt, data, subresources...), &v1alpha1.KubeCluster{})
