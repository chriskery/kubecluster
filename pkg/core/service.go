...
func FilterServicesForReplicaType(services []*v1.Service, replicaType string) ([]*v1.Service, error) {
	...
	selector := labels.SelectorFromValidatedSet(labels.Set{
		kubeclusterorgv1alpha1.ReplicaTypeLabel: replicaType,
	})
...
func GetPortsFromJob(spec *kubeclusterorgv1alpha1.ReplicaSpec, defaultContainerName string) (map[string]int32, error) {
